...
async function resData(sendData:any) {
...
const Login = () => {
  ...
  const loginValid = (() => {
    runInAction(() => {
      state.loginValid = !(!form.getFieldValue('count') || !form.getFieldValue('password'))
    })
        ...
        <div className={Styles.form__login}>
          ...
          <div className={Styles.mod_login_form_login}>
            <ConfigProvider theme={formStyleConfig}>
              ...
              >
                <AntForm.Item label="账号" name="count" rules={[
                ...
                <AntForm.Item label="密码" name="password"  rules={[
